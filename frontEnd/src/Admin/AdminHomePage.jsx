...
export default function AdminHomePage() {
  ...
  const statCards = [
    ...
    { label: 'Total Artworks', value: stats?.totalArtworks || 0, icon: Package,     color: 'bg-purple-500' },
    { label: 'Total Revenue',  value: formatPKR(stats?.totalRevenue || 0), icon: DollarSign, color: 'bg-green-500' },
    { label: 'Total Orders',   value: stats?.totalOrders   || 0, icon: ShoppingBag, color: 'bg-red-500'    },
  ];
          ...
          <div className="bg-white rounded-xl border border-gray-100 shadow-sm p-5">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
              {[
                ...
                { label: 'View Artworks',   path: '/admin/artworks',     color: 'bg-purple-50 text-purple-700 hover:bg-purple-100'},
