...
import {
  ...
  Loader, AlertCircle, MessageCircle
} from 'lucide-react';
...
const MessagesPage = () => {
  ...
  const AvatarFallback = ({ name, avatar, size = 'w-11 h-11', color = 'from-purple-500 to-blue-500' }) => {
            ...
            <div className="p-3 border-b border-gray-100">
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-9 pr-3 py-2 bg-gray-50 border border-gray-200 rounded-xl text-sm outline-none focus:ring-2 focus:ring-purple-400 text-gray-900"
                />
              </div>
            </div>
              ...
              {loadingConvs ? (
                ...
                <div className="text-center py-12 px-4">
                  ...
                  <p className="text-gray-400 text-xs mt-1">
                    Chat with artists from their artwork page
                  </p>
                </div>
              ) : (
              ...
              <>
                ...
                <div className="bg-white border-b border-gray-100 px-4 py-3 flex items-center justify-between shadow-sm flex-shrink-0">
                  <div className="flex items-center gap-3">
                    ...
                    <AvatarFallback
                      name={selectedConv.sellerName}
                      avatar={selectedConv.sellerAvatar}
                      size="w-10 h-10"
                    />
                    <div>
                ...
                <div className="bg-white border-t border-gray-100 p-3 flex-shrink-0">
                  <div className="flex items-center gap-2">
                    ...
                    <button
                      ...
                      className="p-2.5 bg-purple-600 text-white rounded-xl hover:bg-purple-700 transition disabled:opacity-40 disabled:cursor-not-allowed flex-shrink-0"
                    >
                      {sending
