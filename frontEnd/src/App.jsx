...
// ── Smart Home — redirects logged-in users away from landing ──
const SmartHome = () => {
...
// ── Protected Route — redirects guests and wrong roles ──
  ...
  return (
    <Router>
      <Routes>
        ...
        {/* ── Auth — logged-in users get redirected away ── */}
        ...
        {/* ── Buyer ── */}
        {/* ── Buyer — accessible by buyer AND artist (switch mode) ── */}
        ...
        <Route path="/buyer/payment" element={<ProtectedRoute allowedRoles={['buyer', 'artist']}><PaymentPage /></ProtectedRoute>} />
        {/* ── Seller ── */}
